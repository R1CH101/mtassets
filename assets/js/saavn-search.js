    ...
    results_objects[song_id] = {
      ...
      <div class="row" style="margin:auto;">
          ...
          <div class="col" style="border-style:none;padding:2px;">
              ...
              <button class="btn btn-primary song-btn" type="button" style="margin:0px 2px;" onclick='AddDownload("${song_id}")'><img width="20px" src="assets/img/downloading.png" /></button>
